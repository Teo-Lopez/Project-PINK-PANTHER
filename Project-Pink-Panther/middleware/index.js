...
module.exports= {
    ...
    checkRoles: (...roles) => (req, res, next) => {
        roles.includes(req.session.currentUser.role) ? next() : res.render('auth/login-form', { errorMsg: 'No tienes permisos' })
    },
    ...
    checkId: (req,res, next) => {
       ...
       //else res.render('auth/login-form', {errorMsg: 'Inicia sesion para continuar'})
    }
